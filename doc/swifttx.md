...
This mechanism has been integrated into Bitcore-Node-FIAX which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/FIAX-Project/insight-api-fiax#web-socket-api](https://github.com/FIAX-Project/insight-api-fiax#web-socket-api) 
* API: [https://github.com/FIAX-Project/insight-api-fiax#swifttx-transactions](https://github.com/FIAX-Project/insight-api-fiax#swifttx-transactions) 
...
By default, the FIAX Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the FIAX Core daemon:
