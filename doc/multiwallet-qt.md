...
In order to support loading of multiple wallets in fiax-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is fiax.cpp.
...
Changes to fiax.cpp
----------------------
fiax.cpp is the entry point into fiax-qt, and as such, will require some minor modifications to provide hooks for
