...
RESOURCES += src/qt/fiax.qrc src/qt/fiax_locale.qrc

TRANSLATIONS += src/qt/locale/fiax_bg.ts \
                src/qt/locale/fiax_de.ts \
                src/qt/locale/fiax_en.ts \
                src/qt/locale/fiax_es.ts \
                src/qt/locale/fiax_fi.ts \
                src/qt/locale/fiax_fr.ts \
                src/qt/locale/fiax_it.ts \
                src/qt/locale/fiax_ja.ts \
                src/qt/locale/fiax_pl.ts \
                src/qt/locale/fiax_pt.ts \
                src/qt/locale/fiax_ru.ts \
                src/qt/locale/fiax_sk.ts \
                src/qt/locale/fiax_sv.ts \
                src/qt/locale/fiax_vi.ts \
                src/qt/locale/fiax_zh_CN.ts \
                src/qt/locale/fiax_zh_TW.ts
