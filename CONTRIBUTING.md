Contributing to FIAX Core
============================

The FIAX Core project operates an open contributor model where anyone is
...
The following applies to code changes to the FIAX Core project, and is not to be
confused with overall FIAX Network Protocol consensus changes.

Whether a pull request is merged into FIAX Core rests with the project merge
...
Patches that change FIAX consensus rules are considerably more involved than
...
Where a patch set proposes to change the FIAX consensus, it must have been
...
The project leader is the release manager for each FIAX Core release.
