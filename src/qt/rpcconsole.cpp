                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzFIAXPathCustom = GetArg("-zfiaxbackuppath", "");
    ...
    if(!strzFIAXPathCustom.empty()) {
        ui->wallet_customzfiaxbackuppath->setText(QString::fromStdString(strzFIAXPathCustom));
        ui->wallet_customzfiaxbackuppath_label->setVisible(true);
        ui->wallet_customzfiaxbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzFIAXPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the FIAX RPC console.") + "<br>" +
