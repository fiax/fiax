...
QList<TransactionRecord> TransactionRecord::decomposeTransaction(const CWallet* wallet, const CWalletTx& wtx)
{
    ...
    if (wtx.IsCoinStake()) {
        ...
        if (wtx.IsZerocoinSpend() && (fZSpendFromMe || wallet->zfiaxTracker->HasMintTx(hash))) {
            //zFIAX stake reward
            sub.involvesWatchAddress = false;
            sub.type = TransactionRecord::StakeZFIAX;
...
bool IsZFIAXType(TransactionRecord::Type type)
{
    switch (type) {
        case TransactionRecord::StakeZFIAX:
...
void TransactionRecord::updateStatus(const CWalletTx& wtx)
{
    ...
    else if (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::StakeZFIAX || type == TransactionRecord::MNReward) {
