...
/* FIAX GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "FIAX"
#define QAPP_ORG_DOMAIN "fiax.org"
#define QAPP_APP_NAME_DEFAULT "FIAX-Qt"
#define QAPP_APP_NAME_TESTNET "FIAX-Qt-testnet"
