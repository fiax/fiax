                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("FIAX Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a FIAX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and fiax: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zFIAX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About FIAX Core"), this);
    aboutAction->setStatusTip(tr("Show information about FIAX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for FIAX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your FIAX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified FIAX addresses"));
    ...
    openAction->setStatusTip(tr("Open a FIAX: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the FIAX Core help message to get a list with possible FIAX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("FIAX Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FIAX network", "", count));
}
...
{
    QString strTitle = tr("FIAX Core"); // default title
