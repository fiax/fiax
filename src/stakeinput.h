...
#ifndef FIAX_STAKEINPUT_H
#define FIAX_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZFIAX() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zFIAXStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked zfiax, which is a zcspend that has successfully staked
...
public:
    ...
    bool IsZFIAX() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZFIAX() override { return false; }
};


#endif //FIAX_STAKEINPUT_H
