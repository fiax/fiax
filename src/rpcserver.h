...
extern UniValue setzfiaxseed(const UniValue& params, bool fHelp);
extern UniValue getzfiaxseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzfiax(const UniValue& params, bool fHelp);
extern UniValue dzfiaxstate(const UniValue& params, bool fHelp);
