...
public:
    ...
    bool WriteZFIAXSeed(const uint256& hashSeed, const vector<unsigned char>& seed);
    bool ReadZFIAXSeed(const uint256& hashSeed, vector<unsigned char>& seed);
    bool ReadZFIAXSeed_deprecated(uint256& seed);
    bool EraseZFIAXSeed();
    bool EraseZFIAXSeed_deprecated();

    bool WriteZFIAXCount(const uint32_t& nCount);
    bool ReadZFIAXCount(uint32_t& nCount);
