...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("FIAX Core fiax-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  fiax-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded fiax transaction") + "\n" +
                               "  fiax-tx [options] -create [commands]   " + _("Create hex-encoded fiax transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded fiax transaction
