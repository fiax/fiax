...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* FIAX features */
        {"fiax", "masternode", &masternode, true, true, false},
        {"fiax", "listmasternodes", &listmasternodes, true, true, false},
        {"fiax", "getmasternodecount", &getmasternodecount, true, true, false},
        {"fiax", "masternodeconnect", &masternodeconnect, true, true, false},
        {"fiax", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"fiax", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"fiax", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"fiax", "masternodecurrent", &masternodecurrent, true, true, false},
        {"fiax", "masternodedebug", &masternodedebug, true, true, false},
        {"fiax", "startmasternode", &startmasternode, true, true, false},
        {"fiax", "createmasternodekey", &createmasternodekey, true, true, false},
        {"fiax", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"fiax", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"fiax", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"fiax", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"fiax", "getmasternodescores", &getmasternodescores, true, true, false},
        {"fiax", "mnbudget", &mnbudget, true, true, false},
        {"fiax", "preparebudget", &preparebudget, true, true, false},
        {"fiax", "submitbudget", &submitbudget, true, true, false},
        {"fiax", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"fiax", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"fiax", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"fiax", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"fiax", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"fiax", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"fiax", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"fiax", "checkbudgets", &checkbudgets, true, true, false},
        {"fiax", "mnsync", &mnsync, true, true, false},
        {"fiax", "spork", &spork, true, true, false},
        {"fiax", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzfiaxseed", &getzfiaxseed, false, false, true},
        {"zerocoin", "setzfiaxseed", &setzfiaxseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzfiax", &searchdzfiax, false, false, true},
        {"zerocoin", "dzfiaxstate", &dzfiaxstate, false, false, true}
...
{
    return "> fiax-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:6347/\n";
}
