...
#   c) node1 mines 32 blocks, so now node 0 has 60001fiax, node 1 has 4250fiax, node2 has none.
#   d) node0 sends 601 fiax to node2, in two transactions (301 fiax, then 300 fiax).
